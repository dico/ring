...
class PushReceiver extends events_1.EventEmitter {
    ...
    constructor(config) {
        super();
        logger_1.default.setLogLevel(config.logLevel ?? 'NONE');
    ...
    connect = async () => {
        ...
        if (this.config.credentials) {
            ...
            logger_1.default.warn('Missing credentials... Runing register.');
    ...
    async register() {
        const subscription = await (0, gcm_1.default)(this.config);
    ...
    send(message, serverApiKey) {
        ...
        return axios_1.default.post(FCM_SEND_API, data, {
            headers: {
